/**
 * REAL SOAP LOAD TEST - Stress Test (100 RPS)
...
async function runRealLoadTest(rps, durationSeconds) {
    console.log(`\n🚀 STARTING REAL SERVER STRESS TEST: ${rps} req/sec for ${durationSeconds} seconds`);
    ...
    console.log('   Waiting for remaining responses (Longer timeout)...');
    await sleep(12000); // 12 seconds timeout for stress test
    ...
    console.log('\n📊 REAL LOAD TEST RESULTS (100 RPS)');
    console.log('==========================================');
