/**
 * SOAP Load Test - Normal Load (10 RPS)
 */
...
async function runLoadTest(rps, durationSeconds) {
    ...
    console.log(`\n🚀 STARTING NORMAL LOAD TEST: ${rps} req/sec for ${durationSeconds} seconds`);
    console.log('--------------------------------------------------');
    ...
    await sleep(2000); // Wait for potential stragglers
